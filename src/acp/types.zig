...
pub fn writeModelRecoveryInfoUpdate(
    ...
    try writer.writeAll("{\"sessionUpdate\":\"session_info_update\",\"_meta\":{\"x1\":{\"modelResponseRecovery\":");
...
pub fn writeInitializeResponse(w: *std.Io.Writer) !void {
    ...
    try w.writeAll("},\"agentInfo\":{\"name\":\"x1\",\"title\":\"x1\",\"version\":");
...
test "writeInitializeResponse contains required fields" {
    ...
    try std.testing.expect(std.mem.find(u8, out.writer.buffered(), "\"name\":\"x1\"") != null);
