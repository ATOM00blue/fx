...
const outputDir = resolve(process.argv[2] || resolve(repoRoot, "sdk/dist/libx1"));
const requestedNativeAddons = process.argv.slice(3).map((path) => resolve(path));
const defaultNativeAddon = resolve(repoRoot, "zig-out/lib/libx1.node");
...
const requiredNativeNames = new Set([
  "libx1.linux-x64.node",
  "libx1.linux-arm64.node",
  "libx1.darwin-x64.node",
  "libx1.darwin-arm64.node",
]);
const files = [
  ...
  ["sdk/node.js", "node.js"],
  ["sdk/x1-sdk.js", "x1-sdk.js"],
  ["zig-out/bin/x1-core.wasm", "x1-core.wasm"],
  ["zig-out/bin/x1-term.wasm", "x1-term.wasm"],
];
