...
const WARNING = "YOLO enabled: x1 permission checks disabled";
...
function createFixture(prefix: string) {
  ...
  return {
    ...
    settingsPath: join(home, ".x1", "settings.json"),
  };
}
...
describe("yolo permission mode", () => {
  test(
    ...
    async () => {
      const fixture = createFixture("x1-yolo-headless-");
      ...
      const result = await runx1(
        ["ask", "--yolo", "--json", "--no-save", "Run the fixture command exactly once."],
        {
          ...
          env: {
            ...
            X1_AUTO_UPGRADE: "0",
            X1_GATEWAY_BASE_URL: fake.baseUrl,
            X1_GATEWAY_CHAT_URL: fake.chatUrl,
  ...
  test(
    ...
    async () => {
      const fixture = createFixture("x1-yolo-status-");
      writeFileSync(
        fixture.settingsPath,
        JSON.stringify({
  ...
  test(
    ...
    async () => {
      const fixture = createFixture("x1-legacy-sandbox-ps-");
...
describe.skipIf(!tmuxAvailable())("yolo interactive mode", () => {
  test(
    ...
    async () => {
      const fixture = createFixture("x1-yolo-tui-");
  ...
  test(
    ...
    async () => {
      const fixture = createFixture("x1-live-permission-auto-");
  ...
  test(
    ...
    async () => {
      const fixture = createFixture("x1-live-permission-ask-");
  ...
  test(
    ...
    async () => {
      const fixture = createFixture("x1-yolo-ctrl-c-");
      const stderrPath = join(fixture.root, "stderr.log");
      writeFileSync(
        fixture.settingsPath,
        JSON.stringify({
