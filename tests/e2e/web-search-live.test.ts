...
function createIsolatedRoot() {
  const root = realpathSync(mkdtempSync(join(tmpdir(), "x1-web-search-live-")));
          ...
          const result = await runx1(
            ...
            ],
            {
              ...
              env: {
                ...
                X1_TRACE_SCOPES: "agent,gateway,stream,web_search",
                X1_WEB_SEARCH_BACKEND: backend,
              },
              timeoutMs: TIMEOUT,
            },
          );
